...
class CurrencyDropDownTarget extends StatefulWidget {
  final String currencyValue;
  final Function onChanged;
  final String loadingText;

  CurrencyDropDownTarget(
      {@required this.currencyValue,
      @required this.onChanged,
      this.loadingText = "Loading"});

  @override
  _CurrencyDropDownTargetState createState() => _CurrencyDropDownTargetState();
}

class _CurrencyDropDownTargetState extends State<CurrencyDropDownTarget> {
